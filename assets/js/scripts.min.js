...
function parallax(){if($("#js-parallax-window").length>0){var n=$("#js-parallax-background"),e=$("#js-parallax-window"),a=$(e).offset().top,i=$(window).scrollTop(),o=a-i,t=($(n).offset().top,window.innerHeight,.35);n.css("top",-(o*t)+"px")}}$(document).ready(function(){$("#js-parallax-window").length&&parallax()}),$(window).scroll(function(n){$("#js-parallax-window").length&&parallax()});var menuToggle=$("#js-mobile-menu").unbind();$("#js-navigation-menu").removeClass("show"),menuToggle.on("click",function(n){n.preventDefault(),$("#js-navigation-menu").slideToggle(function(){$("#js-navigation-menu").is(":hidden")&&$("#js-navigation-menu").removeAttr("style")})});var sidebarToggle=$("#js-mobile-menu-sidebar").unbind();$("#js-navigation-menu").removeClass("show"),menuToggle.on("click",function(n){n.preventDefault(),$("#js-navigation-menu-sidebar").slideToggle(function(){$("#js-navigation-menu-sidebar").is(":hidden")&&$("#js-navigation-menu-sidebar").removeAttr("style")})}),$(".js-accordion-trigger").bind("click",function(n){jQuery(this).parent().find(".submenu").slideToggle("fast"),jQuery(this).parent().toggleClass("is-expanded"),n.preventDefault()}),$(".js-accordion-trigger-footnotes").bind("click",function(n){jQuery(this).parent().find(".footnotes").slideToggle("fast"),jQuery(this).parent().toggleClass("is-expanded"),n.preventDefault()}),$('a:not([href^="http://www.aba-icc.org/"]):not([href^="#"]):not([href^="/"])').attr("target","_blank");