...
function parallax(){if($("#js-parallax-window").length>0){var n=$("#js-parallax-background"),a=$("#js-parallax-window"),e=$(a).offset().top,o=$(window).scrollTop(),t=e-o,i=($(n).offset().top,window.innerHeight,.35);n.css("top",-(t*i)+"px")}}$(document).ready(function(){$("#js-parallax-window").length&&parallax()}),$(window).scroll(function(n){$("#js-parallax-window").length&&parallax()});var menuToggle=$("#js-mobile-menu").unbind();$("#js-navigation-menu").removeClass("show"),menuToggle.on("click",function(n){n.preventDefault(),$("#js-navigation-menu").slideToggle(function(){$("#js-navigation-menu").is(":hidden")&&$("#js-navigation-menu").removeAttr("style")})}),$(".js-accordion-trigger").bind("click",function(n){jQuery(this).parent().find(".submenu").slideToggle("fast"),jQuery(this).parent().toggleClass("is-expanded"),n.preventDefault()}),$('a:not([href^="http://www.aba-icc.org/"]):not([href^="#"]):not([href^="/"])').attr("target","_blank");